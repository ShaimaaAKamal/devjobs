     ...
     <div className='parent'>
        <div className='container bg-white option px-0'>
            ...
            <div className="col-md-4 col-lg-5  d-md-none">
              ...
              <div className="col-md-4 col-lg-3 border-end border-start d-none d-md-block">
                    <div className="input-group ">
                        ...
                        <input type="text" className="form-control rounded-0 form-control-lg" placeholder="Filter by location…" id='locationKey' aria-label="Filter Key" aria-describedby="basic-addon1"/>
                    </div>
              </div>
