        ...
        <div className='container bg-white option px-0 lightSite '>
            ...
            <div className="col-md-4 col-lg-5  d-md-none">
              ...
              <div className="input-group">
                  ...
                  <input type="text" className="form-control  titleKey rounded-0 form-control-lg d-md-inline-block d-lg-none" placeholder="Filter by title"  aria-label="Filter Key" aria-describedby="basic-addon1"/>
                  <input type="text" className="form-control  titleKey rounded-0 form-control-lg d-lg-inline-block d-none " placeholder="Filter by title, companies, expertise…" id='titleKey' aria-label="Filter Key" aria-describedby="basic-addon1"/>
